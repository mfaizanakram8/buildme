          ...
          <div className='mt-12 ml-9'>
            <div className='bg-[#37393A] h-[250px] w-[450px] flex flex-col justify-center items-center'>
              <div className='flex flex-row mr-[74px]'>
                ...
                <h1 className='text-2xl text-white font-semibold mt-4 ml-5 Gilroy-bold'>Construction Services</h1>
              </div>
              <div className='text-start ml-20 text-white Gilroy-medium'>
                <p>
                  Far far away, behind the word mountains, far <br />
                  from the countries Vokalia and Consonantia,<br />
                  there live blind texts.
                </p>
                <button className='Gilroy-bold bg-white px-3 py-2 text-custom-yellow rounded-md font-semibold text-[14px] mt-5 hover:bg-custom-yellow hover:text-white'>
                  LEARN MORE
                </button>
              </div>
            </div>
          ...
          <div className='mt-3 ml-9'>
            <div className='bg-[#EBAE15] h-[250px] w-[450px] flex flex-col justify-center items-center'>
              <div className='flex flex-row mr-[74px]'>
                ...
                <h1 className='text-2xl text-white font-semibold mt-4 ml-5 Gilroy-bold'>Infrastrcture Services</h1>
              </div>
              <div className='text-start ml-20 text-white Gilroy-medium'>
                <p>
                  Far far away, behind the word mountains, far <br />
                ...
                <button className='Gilroy-bold bg-white px-3 py-2 text-custom-yellow rounded-md font-semibold text-[14px] mt-5 hover:bg-gray-500 hover:text-white'>
                  LEARN MORE
                </button>
              </div>
            </div>
          ...
          <div className='mt-4 ml-9'>
            <div className='bg-[#37393A] h-[250px] w-[450px] flex flex-col justify-center items-center'>
              <div className='flex flex-row mr-[74px]'>
                ...
                <h1 className='text-2xl text-white font-semibold mt-4 ml-5 Gilroy-bold'>Archietecture Services</h1>
              </div>
              <div className='text-start ml-20 text-white Gilroy-medium'>
                <p>
                  Far far away, behind the word mountains, far <br />
